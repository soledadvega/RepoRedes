...
def create_socket():#(servidor)
    ...
    UDPsocket.bind((RECEPTOR_IP, RECEPTOR_PORT)) #es para saber donde tiene que escuchar el ip y parta del archivo constantes
    return UDPsocket
...
def rdt_recv(socket):#recibe la data de la red, obtengo dato, descomprime data , obtiene el pkt y emisor
    datos=socket.recvfrom(2048) #tamaño del paquete que recibe
